...
// ${this.makeDropdown("Refresh button locations", "refresh_locations", refresh_options )}
  ...
  _valueChanged(ev) {
    ...
    // Config collections
    this._config.battery_flow = this._config.battery_flow ?? {};
    this._config.battery_soc = this._config.battery_soc ?? {};
    this._config.grid_flow = this._config.grid_flow ?? {};
    this._config.home_consumption = this._config.home_consumption ?? {};
    ...
    this._config.pv_power = this._config.pv_power ?? {};
    this._config.battery_voltage = this._config.battery_voltage ?? {};
    this._config.grid_voltage = this._config.grid_voltage ?? {};
    this._config.backup_power = this._config.backup_power ?? {};
    this._config.temp = this._config.temp ?? {};
    this._config.energy_allocations = this._config.energy_allocations ?? {};
    ...
    this._config.battery_flow.entities = detail.value.battery_flow_entities ?? [] ;
